...
**Apply:** Get clear direction from the task context or user input, then iterate autonomously on implementation.
...
**Apply:** Define the `grep` command, `awk` pipeline, or equivalent extractor that returns the metric BEFORE starting.
